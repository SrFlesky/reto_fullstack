      ...
      <div className="bg-white grid grid-cols-1 md:grid-cols-2 gap-16 px-8 py-20 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-base font-medium">Colombia</h2>
        ...
        <div className="flex flex-col gap-4">
          ...
          />
          <button className="bg-black text-white px-8 py-4 text-xs uppercase tracking-widest hover:bg-[#E8540A] transition-colors duration-200 cursor-pointer self-start">
            Enviar mensaje
          </button>
        </div>
      </div>
